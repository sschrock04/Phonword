...
with open(r'C:\Users\Stephen\Downloads\wuggy\correlationMixed.csv', 'w', newline='') as output:
    w = csv.writer(output)
    ...
    for i in range(numSims):
        ...
        for i in range(0, len(df)):
            ...
            w1vec = np.concatenate((w1vecH_c_tr, w1vecPC_c_o))
            w2vec = np.concatenate((w2vecH_c_tr, w2vecPC_c_o))
            ...
            w1vec = np.concatenate((w1vecH_a_tr, w1vecPC_a_o))
            w2vec = np.concatenate((w2vecH_a_tr, w2vecPC_a_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_b_tr, w1vecPC_b_o))
            w2vec = np.concatenate((w2vecH_b_tr, w2vecPC_b_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_c_tr, w1vecPCS_c_o))
            w2vec = np.concatenate((w2vecH_c_tr, w2vecPCS_c_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_a_tr, w1vecPCS_a_o))
            w2vec = np.concatenate((w2vecH_a_tr, w2vecPCS_a_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_b_tr, w1vecPCS_b_o))
            w2vec = np.concatenate((w2vecH_b_tr, w2vecPCS_b_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_c_tr, w1vecPI_c_o))
            w2vec = np.concatenate((w2vecH_c_tr, w2vecPI_c_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_a_tr, w1vecPI_a_o))
            w2vec = np.concatenate((w2vecH_a_tr, w2vecPI_a_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
            ...
            w1vec = np.concatenate((w1vecH_b_tr, w1vecPI_b_o))
            w2vec = np.concatenate((w2vecH_b_tr, w2vecPI_b_o))
            cossim = 1 - spatial.distance.cosine(w1vec, w2vec)
